...
Public Class CRBeritaAcaraRetensi
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRBeritaAcaraRetensi.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "level6_retensi_rekammedis.CRBeritaAcaraRetensi.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRBeritaAcaraRetensi
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRBeritaAcaraRetensi = New CRBeritaAcaraRetensi()
        rpt.Site = Me.Site
        Return rpt
    End Function
