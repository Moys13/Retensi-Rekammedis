...
Public Class CRLaporanInaktif
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "level6_retensi_rekammedis.CRLaporanInaktif.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRLaporanInaktif
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRLaporanInaktif = New CRLaporanInaktif()
        rpt.Site = Me.Site
        Return rpt
    End Function
